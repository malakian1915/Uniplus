...
class Payment extends StatefulWidget {
  ...
  Payment(this._user, this._languageCode, this._selectedPlan);
                ...
                children: <Widget>[
                  ...
                  Text(
                    price.getStringLanguage(widget._languageCode) +
                        ": " +
                        moneyCode.getStringLanguage(widget._languageCode) +
                        widget._selectedPlan.price.toString(),
                    style: TextStyle(
                      fontSize: 30,
                  ...
                  _isPaying
                      ...
                      : GestureDetector(
                            ...
                            if (_formKey.currentState.validate()) {
                              ...
                              var _paymentModel = new PaymentModel(
                                ...
                                debitCredit: _debito
                                    ? debit
                                        .getStringLanguage(widget._languageCode)
                                    : credit.getStringLanguage(
                                        widget._languageCode),
                              );

                              PaymentController.getInstance().salvarPayment(
                                  _paymentModel, widget._selectedPlan);
                              ...
                              showDialog(
                                ...
                                builder: (BuildContext context) {
                                  return AlertDialog(
                                    ...
                                    title: Text(
                                        paymentSucceeded.getStringLanguage(
                                            widget._languageCode),
                                        style: TextStyle(
                                            color: Colors.white,
                                            fontWeight: FontWeight.bold)),
                          ...
                          child: Container(
                            ...
                            child: Text(
                              pay.getStringLanguage(widget._languageCode),
                              style: TextStyle(
                                fontWeight: FontWeight.bold,
                                color: Colors.white,
                                fontSize: 20,
